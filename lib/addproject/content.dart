...
class ContentState extends State<Content> {
  ...
  submit() {
    if (_formKey.currentState.validate()) {
      try {
        PostdataService()
            .postEdit1(widget.postid, title.text, about.text, desc.text);
      } finally {
        print('error');
      }
      return true;
    ...
    return Scaffold(
      body: StreamBuilder<Post>(
          ...
          builder: (context, snapshot) {
            ...
            desc.text = snapshot.data.shortdesc;
            about.text = snapshot.data.about;
            return Form(
              key: _formKey,
              child: Column(
                children: [
                  ...
                  bigfield(
                      'Basic info about project', Colors.grey[200], 270, about),
                  SizedBox(
                    height: 40,
                  ),
                ],
